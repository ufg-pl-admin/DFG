#' Tworzy obiekt data.frame z miarami spraw niezgodności dla rozliczeń w podziale na statusy
#'
...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP007BDS_prepared_data_6.
#' @return Obiekt data.frame z miarami spraw niezgodności w podziale na statusy.
#'
#' @examples
#' DATA_RAP007BDS_6(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP007BDS_prepared_data_6
#' @export
source(paste(getwd(), '/utils/int_breaksUtil.R', sep=""))
source(paste(getwd(), '/utils/labelUtil.R', sep=""))  

DATA_RAP007BDS_6 <- function(json_content) {
  df_main_2 <- getRAP007BDS_prepared_data_5(json_content)
...
#' @export
INFOGRAPHIC_RAP007BDS_6 <- function(json_content) {
  df_main_2 <-  getRAP007BDS_prepared_data_5(json_content)
