...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP007BDS_prepared_data_2.
#' @return Obiekt data.frame z miarami spraw niezgodności w podziale na statusy.
#'
#' @examples
#' DATA_RAP007BDS_2(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP007BDS_prepared_data_2
#' @export
DATA_RAP007BDS_2 <- function(json_content) {
...
#' @importFrom getRAP007BDS_prepared_data_2
#' @export
INFOGRAPHIC_RAP007BDS_2 <- function(json_content) {
  df_main_2 <-  getRAP007BDS_prepared_data_2(json_content)
