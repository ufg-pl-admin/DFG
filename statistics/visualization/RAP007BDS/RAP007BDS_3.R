...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP007BDS_prepared_data_3.
#' @return Obiekt data.frame z miarami spraw niezgodności w podziale na statusy.
#'
#' @examples
#' DATA_RAP007BDS_3(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP007BDS_prepared_data_3
#' @export
source(paste(getwd(), '/utils/int_breaksUtil.R', sep=""))
source(paste(getwd(), '/utils/labelUtil.R', sep="")) 

DATA_RAP007BDS_3 <- function(json_content) {
  df_main_2 <- getRAP007BDS_prepared_data_2(json_content)
...
#' @importFrom getRAP007BDS_prepared_data_3
#' @export
INFOGRAPHIC_RAP007BDS_3 <- function(json_content) {
  df_main_2 <-  getRAP007BDS_prepared_data_2(json_content)
