...
getRAP007BDS_prepared_data_1 <- function(json_content) {
  #print(json_content)
  colnames(json_content) <- c("L_NIEZGODNOSCI", "L_MRP", "L_DEV", "L_ROZ", "L_INEGRACJI", "SR_CZAS")
...
#' Pobierz i przygotuj dane dla RAP007BDS_2 i RAP007BDS_3
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP007BDS_3. Przetwarza dane JSON,
...
#'
#' @export
getRAP007BDS_prepared_data_2 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP007BDS_4
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP007BDS_4. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
#'
#' @export
getRAP007BDS_prepared_data_3 <- function(json_content) {
  colnames(json_content) <- c("L_WWER",
                              "L_ROZW",
                              "L_ODRZ",
                              "L_DOPR",
...
#' Pobierz i przygotuj dane dla RAP007BDS_5
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP007BDS_5. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
#'
#' @export
getRAP007BDS_prepared_data_4 <- function(json_content) {
  colnames(json_content) <- c("L_WWER",
                              "L_ROZW",
                              "L_ODRZ",
                              "L_DOPR",
...
#' Pobierz i przygotuj dane dla RAP007BDS_6
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP007BDS_6. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
#'
#' @export
getRAP007BDS_prepared_data_5 <- function(json_content) {
  colnames(json_content) <- c("L_WWER",
                              "L_ROZW",
                              "L_ODRZ",
                              "L_DOPR",
...
#' Pobierz i przygotuj dane dla RAP007BDS_7
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP007BDS_7. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
#'
#' @export
getRAP007BDS_prepared_data_6 <- function(json_content) {
