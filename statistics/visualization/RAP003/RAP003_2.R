#' Pobierz i przygotuj dane dla RAP003_2
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP003_2. Przetwarza dane JSON,
...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP003_prepared_data_2.
...
#' @importFrom getRAP003_prepared_data_2
#' @export

DATA_RAP003_2 <- function(json_content) {
...
INFOGRAPHIC_RAP003_2<- function(json_content) {
