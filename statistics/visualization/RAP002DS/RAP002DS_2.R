...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002DS_prepared_data_2.
#' @return Obiekt data.frame z liczbą skorygowanych zasileń.
#'
#' @examples
#' DATA_RAP002DS_2(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP002DS_prepared_data_2
#' @export
DATA_RAP002DS_2 <- function(json_content) {
  df_main_2 <- getRAP002DS_prepared_data_2(json_content)
...
#' @importFrom getRAP002DS_prepared_data_2
#' @export
INFOGRAPHIC_RAP002DS_2 <- function(json_content) {
  df_main_2 <-  getRAP002DS_prepared_data_2(json_content)
