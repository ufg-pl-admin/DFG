#' Pobierz i przygotuj dane dla RAP002DS_1
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002DS_1. Przetwarza dane JSON,
...
getRAP002DS_prepared_data_1 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002DS_2
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002DS_2. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002DS_prepared_data_2 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002DS_3
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002DS_3. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002DS_prepared_data_3 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002DS_4
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002DS_4. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002DS_prepared_data_4 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002DS_5
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002DS_5. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002DS_prepared_data_5 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002DS_6
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002DS_6. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002DS_prepared_data_6 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002DS_7
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002DS_7. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002DS_prepared_data_7 <- function(json_content) {
