...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002DS_prepared_data_7.
#' @return Obiekt data.frame z liczbą skorygowanych zasileń.
#'
#' @examples
#' DATA_RAP002DS_7(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP002DS_prepared_data_7
#' @export
DATA_RAP002DS_7 <- function(json_content) {
  df_main_2 <- getRAP002DS_prepared_data_7(json_content)
...
#' @importFrom getRAP002DS_prepared_data_7
#' @export
INFOGRAPHIC_RAP002DS_7 <- function(json_content) {
  df_main <- getRAP002DS_prepared_data_7(json_content)
  df_main$L_SKORYGOWANYCH <- as.numeric(df_main$L_SKORYGOWANYCH)
