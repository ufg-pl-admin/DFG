...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004_prepared_data_5.
...
#' @importFrom getRAP004_prepared_data_5
#' @export
DATA_RAP004_5 <- function(json_content) {
...
INFOGRAPHIC_RAP004_5 <- function(json_content) {
  df_main_2 <-  getRAP004_prepared_data_4(json_content)
