...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004_prepared_data_3.
...
#' @importFrom getRAP004_prepared_data_3
#' @export
DATA_RAP004_3 <- function(json_content) {
...
INFOGRAPHIC_RAP004_3 <- function(json_content) {
  df_main_2 <-  getRAP004_prepared_data_3(json_content)
