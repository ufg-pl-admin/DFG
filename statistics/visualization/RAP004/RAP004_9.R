...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004_prepared_data_9.
...
#' @importFrom getRAP004_prepared_data_9
#' @export
DATA_RAP004_9 <- function(json_content) {
  df_main_2 <- getRAP004_prepared_data_6(json_content)
...
#' @importFrom getRAP004_prepared_data_9
#' @export
INFOGRAPHIC_RAP004_9 <- function(json_content) {
  df_main_2 <-  getRAP004_prepared_data_6(json_content)
