...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004_prepared_data_7.
...
#' @importFrom getRAP004_prepared_data_7
#' @export
DATA_RAP004_7 <- function(json_content) {
...
#' @importFrom getRAP004_prepared_data_7
#' @export
INFOGRAPHIC_RAP004_7 <- function(json_content) {
  df_main_2 <-  getRAP004_prepared_data_5(json_content)
