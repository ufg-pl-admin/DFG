...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004_prepared_data_1.
#' @return Obiekt data.frame z miarami mrp i umów deweloperskich.
#'
#' @examples
#' DATA_RAP004_1(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP004_prepared_data_1
#' @export

DATA_RAP004_1 <- function(json_content) {
  df_main_2 <- getRAP004_prepared_data_1(json_content)
...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004_prepared_data_1.
#' @return Obiekt grob_table z trzema tabelami opisującymi mrp i umów deweloperskich.
#'
#' @examples
#' INFOGRAPHIC_RAP004_1(NULL)
#'
#' @importFrom utils assign
...
INFOGRAPHIC_RAP004_1 <- function(json_content) {
  df_main_2 <-  getRAP004_prepared_data_1(json_content)
