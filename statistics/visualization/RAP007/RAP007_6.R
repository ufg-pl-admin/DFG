...
DATA_RAP007_6 <- function(json_content) {
  df_main_2 <- getRAP007_prepared_data_5(json_content)
...
#' @export
INFOGRAPHIC_RAP007_6 <- function(json_content) {
  df_main_2 <-  getRAP007_prepared_data_5(json_content)
