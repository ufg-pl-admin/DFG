...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP007_prepared_data_5.
...
#' @importFrom getRAP007_prepared_data_5
#' @export
source(paste(getwd(), '/utils/int_breaksUtil.R', sep=""))
source(paste(getwd(), '/utils/labelUtil.R', sep=""))  

DATA_RAP007_5 <- function(json_content) {
  df_main_2 <- getRAP007_prepared_data_4(json_content)
...
#' zawierającymi miary spraw niezgodności w podziale na statusy.
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP007_prepared_data_4.
#' @return Obiekt grob_table prezentujący miary spraw niezgodności w podziale na statusy.
#'
#' @examples
#' INFOGRAPHIC_RAP007_4(NULL)
#'
#' @importFrom utils assign
#' @importFrom gridExtra tableGrob
#' @importFrom ggplot2 ggdraw draw_image theme_void annotation_custom plot_grid
#' @importFrom getRAP007_prepared_data_4
#' @export
INFOGRAPHIC_RAP007_5 <- function(json_content) {
  df_main_2 <-  getRAP007_prepared_data_4(json_content)
