#' Tworzy obiekt data.frame z miar zasileń po terminie WPLMRP, INSKLA i DANEAN.
#'
#' Funkcja tworzy i zwraca obiekt data.frame z trzema kolumnami,
#' zawierającymi miary miar zasileń po terminie WPLMRP, INSKLA i DANEAN.
#'
#' @examples
#' DATA_RAP003BDS_5(NULL)
#'
#' @export
options(scipen=999)
...
DATA_RAP003BDS_5 <- function(json_content) {
...
#'
#' Funkcja tworzy i zwraca obiekt data.frame z trzema kolumnami,
#' zawierającymi miary poprawnie zasileń po terminie WPLMRP, INSKLA i DANEAN.
#'
#' @return Obiekt ggplot z zasileń po terminie WPLMRP, INSKLA i DANEAN.
#'
#' @examples
#' INFOGRAPHIC_RAP003BDS_5(NULL)
#'
...
INFOGRAPHIC_RAP003BDS_5<- function(json_content) {
  df <- DATA_RAP003BDS_5(json_content)
