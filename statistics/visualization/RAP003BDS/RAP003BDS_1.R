#' Pobierz i przygotuj dane dla RAP003BDS_1
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP003BDS_1. Przetwarza dane JSON,
...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP003BDS_prepared_data.
#' @return Obiekt data.frame z liczbą zasileń WPLMRP, INSKLA i DANEAN.
#'
#' @examples
#' DATA_RAP003BDS_1(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP003BDS_prepared_data
#' @export

DATA_RAP003BDS_1 <- function(json_content) {
...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP003BDS_prepared_data.
#' @return Obiekt ggplot z ikoną oraz pięcioma tabelami opisującymi liczbę reguł walidacyjnych.
#'
#' @examples
#' INFOGRAPHIC_RAP003BDS_1(NULL)
#'
#' @importFrom utils assign
...
INFOGRAPHIC_RAP003BDS_1<- function(json_content) {
...
DANEAN do WPLMRP"))
  ...
  zaległych składek
           bez DANEAN           "))
  df13 <- data.frame(var1=c(df_main$LICZBA_WPLATY_BEZ_INSKLA,"liczba
  zaległych składek
bez INSKLA"))
