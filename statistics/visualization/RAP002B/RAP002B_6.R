...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002B_prepared_data_6.
...
#' @importFrom getRAP002B_prepared_data_6
#' @export
DATA_RAP002B_6 <- function(json_content) {
  df_main_2 <- getRAP002B_prepared_data_6(json_content)
...
INFOGRAPHIC_RAP002B_6 <- function(json_content) {
  df_main_2 <- getRAP002B_prepared_data_6(json_content)
