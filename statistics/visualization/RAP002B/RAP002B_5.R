...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002B_prepared_data_5.
...
#' @importFrom getRAP002B_prepared_data_5
#' @export
DATA_RAP002B_5 <- function(json_content) {
  df_main_2 <- getRAP002B_prepared_data_5(json_content)
...
INFOGRAPHIC_RAP002B_5 <- function(json_content) {
  df_main_2 <- getRAP002B_prepared_data_5(json_content)
