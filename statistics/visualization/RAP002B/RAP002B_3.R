...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002B_prepared_data_3.
...
#' @importFrom getRAP002B_prepared_data_3
#' @export

DATA_RAP002B_3 <- function(json_content) {
  df_main_2 <- getRAP002B_prepared_data_3(json_content)
...
INFOGRAPHIC_RAP002B_3 <- function(json_content) {
  df_main_2 <-  getRAP002B_prepared_data_3(json_content)
