...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002B_prepared_data_1.
...
#' @importFrom getRAP002B_prepared_data_1
#' @export

DATA_RAP002B_1 <- function(json_content) {
  df_main_2 <- getRAP002B_prepared_data_1(json_content)
...
#' @export
INFOGRAPHIC_RAP002B_1 <- function(json_content) {
  df_main_2 <-  getRAP002B_prepared_data_1(json_content)
