#' Pobierz i przygotuj dane dla RAP002B_1
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002B_1. Przetwarza dane JSON,
...
getRAP002B_prepared_data_1 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002B_2
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002B_2. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002B_prepared_data_2 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002B_3
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002B_3. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002B_prepared_data_3 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002B_4
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002B_4. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002B_prepared_data_4 <- function(json_content) {
  #print(json_content)
...
#' Pobierz i przygotuj dane dla RAP002B_5
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002B_5. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002B_prepared_data_5 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002B_6
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002B_6. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002B_prepared_data_6 <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP002B_7
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP002B_7. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRAP002B_prepared_data_7 <- function(json_content) {
