...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004DS_prepared_data_2.
#' @return Obiekt data.frame z miarami liczb i kwot składek rozliczeń.
#'
#' @examples
#' DATA_RAP004DS_2(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP004DS_prepared_data_2
#' @export
DATA_RAP004DS_2 <- function(json_content) {
  df_main_2 <- getRAP004DS_prepared_data_2(json_content)
...
INFOGRAPHIC_RAP004DS_2 <- function(json_content) {
  df_main_2 <-  getRAP004DS_prepared_data_2(json_content)
