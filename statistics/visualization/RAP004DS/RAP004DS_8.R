...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004DS_prepared_data_8.
#' @return Obiekt data.frame z miarami inwestycji w podziale na statusy DFG.
#'
#' @examples
#' DATA_RAP004DS_8(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP004DS_prepared_data_8
#' @export
source(paste(getwd(), '/utils/int_breaksUtil.R', sep=""))
source(paste(getwd(), '/utils/labelUtil.R', sep=""))  

DATA_RAP004DS_8 <- function(json_content) {
...
#' @importFrom getRAP004Ds_prepared_data_8
#' @export
INFOGRAPHIC_RAP004DS_8 <- function(json_content) {
  df_main_2 <-  getRAP004DS_prepared_data_5(json_content)
