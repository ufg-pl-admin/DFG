...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004DS_prepared_data_4.
#' @return Obiekt data.frame z miarami kompletności zasileń umów MRP w podziale na statusy.
#'
#' @examples
#' DATA_RAP004DS_4(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP004DS_prepared_data_4
#' @export
DATA_RAP004DS_4 <- function(json_content) {
...
INFOGRAPHIC_RAP004DS_4 <- function(json_content) {
  df_main_2 <-  getRAP004DS_prepared_data_3(json_content)
