...
getRAP004DS_prepared_data_1 <- function(json_content) {
  #print(json_content)
...
getRAP004DS_prepared_data_2 <- function(json_content) {

    colnames(json_content) <- c("L_WPLAT", "KWOTA_WPLAT", "L_WYPLAT_Z", "KWOTA_Z", "L_WYPLAT_SPOZA", "KWOTA_SPOZA", 
                              "L_ROZLICZONYCH", "KWOTA_ROZLICZONA", "L_NIEROZLICZONYCH", "KWOTA_NIEROZLICZONA", "L_ZALEGLYCH", "KWOTA_ZALEGLA")
  df_main <- as.data.frame(json_content)
...
getRAP004DS_prepared_data_3 <- function(json_content) {
...
getRAP004DS_prepared_data_4 <- function(json_content) {
  #print(json_content)
...
getRAP004DS_prepared_data_5 <- function(json_content) {
  #print(json_content)
...
getRAP004DS_prepared_data_6 <- function(json_content) {
  #print(json_content)
