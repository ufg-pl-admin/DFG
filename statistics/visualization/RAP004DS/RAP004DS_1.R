...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004DS_prepared_data_1.
#' @return Obiekt data.frame z miarami liczb i kwot składek rozliczeń.
#'
#' @examples
#' DATA_RAP004DS_1(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP004DS_prepared_data_1
#' @export
DATA_RAP004DS_1 <- function(json_content) {
  df_main_2 <- getRAP004DS_prepared_data_1(json_content)
...
INFOGRAPHIC_RAP004DS_1 <- function(json_content) {
  df_main_2 <-  getRAP004DS_prepared_data_1(json_content)
