...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP009B_prepared_data_1.
...
#' @importFrom getRAP009B_prepared_data_1
#' @export
DATA_RAP009B_1 <- function(json_content) {
  
  df_main <- getRap_009B_1_prepared_data(json_content)
  df <- data.frame(
...
INFOGRAPHIC_RAP009B_1<- function(json_content) {
