...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP009B_prepared_data_3.
...
#' @importFrom getRAP009B_prepared_data_3
#' @export
DATA_RAP009B_3 <- function(json_content) {
  
  df <- getRap_009B_3_prepared_data(json_content)
...
INFOGRAPHIC_RAP009B_3<- function(json_content) {
  
  df1<- DATA_RAP009B_3(json_content)
