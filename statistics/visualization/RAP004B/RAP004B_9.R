...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004B_prepared_data_9.
...
#' @importFrom getRAP004B_prepared_data_9
#' @export
DATA_RAP004B_9 <- function(json_content) {
  df_main_2 <- getRAP004B_prepared_data_6(json_content)
...
#' @importFrom getRAP004B_prepared_data_9
#' @export
INFOGRAPHIC_RAP004B_9 <- function(json_content) {
  df_main_2 <-  getRAP004B_prepared_data_6(json_content)
