...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP004B_prepared_data_3.
...
#' @importFrom getRAP004B_prepared_data_3
#' @export
DATA_RAP004B_3 <- function(json_content) {
...
INFOGRAPHIC_RAP004B_3 <- function(json_content) {
  df_main_2 <-  getRAP004B_prepared_data_3(json_content)
