...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP009DS_prepared_data_4.
#' @return Obiekt data.frame z liczbą wystapień anomalii.
#'
#' @examples
#' DATA_RAP009DS_4(NULL)
#'
#' @importFrom utils assign
#' @importFrom getRAP009DS_prepared_data_4
#' @export
DATA_RAP009DS_4 <- function(json_content) {
  
  df <- getRap_009DS_4_prepared_data(json_content)
...
#' @importFrom getRAP009DS_prepared_data_4
#' @export
INFOGRAPHIC_RAP009DS_4<- function(json_content) {
  df <- DATA_RAP009DS_4(json_content)
