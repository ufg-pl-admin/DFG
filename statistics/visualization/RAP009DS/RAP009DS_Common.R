#' Pobierz i przygotuj dane dla RAP009DS_1
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP009DS_1. Przetwarza dane JSON,
...
getRap_009DS_1_prepared_data <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP009DS_2
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP009DS_2. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRap_009DS_2_prepared_data <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP009DS_3
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP009DS_3. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRap_009DS_3_prepared_data <- function(json_content) {
...
#' Pobierz i przygotuj dane dla RAP009DS_4
#'
#' Funkcja przygotowuje dane dla infografiki i tabeli danych dla RAP009DS_4. Przetwarza dane JSON,
#' konwertuje wartości i formatuje je w odpowiedni sposób.
#'
#' @param json_content Ramka danych w formacie JSON do przetworzenia.
#' @return df_main Ramka danych z przetworzonymi wartościami.
...
getRap_009DS_4_prepared_data <- function(json_content) {
