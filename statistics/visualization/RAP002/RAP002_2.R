...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002_prepared_data_2.
...
#' @importFrom getRAP002_prepared_data_2
#' @export
DATA_RAP002_2 <- function(json_content) {
  df_main_2 <- getRAP002_prepared_data_2(json_content)
...
#' @importFrom getRAP002_prepared_data_2
#' @export
INFOGRAPHIC_RAP002_2 <- function(json_content) {
  df_main_2 <-  getRAP002_prepared_data_2(json_content)
