...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002_prepared_data_1.
...
#' @importFrom getRAP002_prepared_data_1
#' @export

DATA_RAP002_1 <- function(json_content) {
  df_main_2 <- getRAP002_prepared_data_1(json_content)
...
INFOGRAPHIC_RAP002_1 <- function(json_content) {
  df_main_2 <-  getRAP002_prepared_data_1(json_content)
