...
#'
#' @param json_content Argument wykorzystywany w funkcji getRAP002_prepared_data_6.
...
#' @importFrom getRAP002_prepared_data_6
#' @export
DATA_RAP002_6 <- function(json_content) {
  df_main_2 <- getRAP002_prepared_data_6(json_content)
...
INFOGRAPHIC_RAP002_6 <- function(json_content) {
  df_main_2 <- getRAP002_prepared_data_6(json_content)
